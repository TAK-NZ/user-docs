---
title: TAK.NZ Documentation
description: Documentation for TAK.NZ, New Zealand's shared situational awareness platform for emergency responders.
hide:
  - navigation
  - toc
---
...
TAK.NZ is built on TAK (Team Awareness Kit), the same technology used by public safety and defence organisations around the world. It runs on your phone (ATAK for Android, TAK Aware for iPhone), on a laptop (WinTAK), or straight in your browser (CloudTAK) — no specialised hardware required.

<div class="grid cards" markdown>

- :material-lightbulb-on-outline:{ .lg .middle } **New to TAK.NZ?**

    ---

    Start with the concepts: what TAK is, how the Common Operating Picture works, and why it matters for New Zealand public safety.

    [:octicons-arrow-right-24: Learn the concepts](concepts/index.md)

- :material-rocket-launch-outline:{ .lg .middle } **Ready to get started?**

    ---

    Create your account and log in to the TAK.NZ account portal — the first step before using any client.

    [:octicons-arrow-right-24: Get started](getting-started/index.md)

- :material-cellphone-link:{ .lg .middle } **Install a client**

    ---

    Set up CloudTAK, ATAK, TAK Aware, or WinTAK on your device, including QR-code enrolment for mobile clients.
...
- :material-radar:{ .lg .middle } **External Feeds**
    ...
    Bring in live aircraft (ADS-B) and vessel (AIS) tracking alongside your team's positions.
